...
SELECT  tpep_dropoff_datetime, passenger_count, trip_distance, payment_type, total_amount, tip_amount, (tip_amount/total_amount)*100 AS tip_percent
FROM yellow
WHERE passenger_count < 4
  AND total_amount < 80 
  AND tip_amount > 0
